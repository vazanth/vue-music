  ...
  data() {
    return {
      ...
      songSchema: {
        ...
        genre: 'required|min:3|max:10|alpha_spaces',
      },
    };
  },
  methods: {
    async editSong(values) {
      ...
      try {
        ...
        this.alert_msg = 'Unexpected Error! Please try again later';
        return;
      }
    ...
    async deleteSong() {
      this.show_alert = true;
      this.alert_variant = 'bg-blue-500';
      this.alert_msg = 'Please wait! Deleting Song';
      try {
        ...
        songCollection.doc(this.song.docId).delete();
      } catch (error) {
        this.alert_variant = 'bg-red-600';
        this.alert_msg = 'Unexpected Error! Please try again later';
        return;
      ...
      this.alert_variant = 'bg-green-500';
      this.alert_msg = 'Song deleted Successfully';
