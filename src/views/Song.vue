...
import { auth, songCollection, commentCollection } from '@/includes/firebase';
  ...
  methods: {
    ...
    async addComment(values, { resetForm }) {
      ...
      try {
        ...
        this.comment_alert_msg = 'An unexpected error occured!';
        return;
      }
      this.getComments();
      this.comment_in_submission = false;
    ...
    async getComments() {
      const snapshot = await commentCollection.where('songId', '==', this.$route.params.id).get();
